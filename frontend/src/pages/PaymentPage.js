...
const PaymentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      {/* Sözleşme Modal */}
      {showContractModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[100] flex items-center justify-center p-4 pb-20 md:pb-4">
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[85vh] md:max-h-[90vh] overflow-hidden">
