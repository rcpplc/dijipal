...
{/* Sözleşme Modal */}
          {showContractModal && (
            <div className="fixed inset-0 bg-black bg-opacity-50 z-[100] flex items-center justify-center">
              <div className="bg-white w-screen h-screen md:rounded-xl overflow-y-auto flex flex-col">
                ...
                {/* İçerik Alanı */}
                <div className="flex-1 p-6 space-y-6 text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="text-sm space-y-3">
                      <p><strong>Madde 1 - Taraflar:</strong> Bu sözleşme, Mavibilet şirketi ile müşteri arasında imzalanmıştır.</p>
                      <p><strong>Madde 2 - Sözleşme Konusu:</strong> Bu sözleşme, müşterinin elektronik ortamda sipariş verdiği ürün/hizmetin satış ve teslimat koşullarını düzenlemektedir.</p>
                      <p><strong>Madde 3 - Cayma Hakkı:</strong> Müşteri, 14 gün içerisinde herhangi bir gerekçe göstermeksizin ve cezai şart ödemeksizin sözleşmeden cayma hakkına sahiptir.</p>
                      <p><strong>Madde 4 - Teslimat:</strong> Ürün/hizmet, en geç 30 gün içerisinde teslim edilecektir.</p>
                      <p><strong>Madde 5 - Ödeme:</strong> Ödeme, güvenli ödeme sistemleri üzerinden gerçekleştirilecektir.</p>
                      <p><strong>Madde 6 - Yürürlük:</strong> Bu sözleşme, elektronik ortamda onaylandığı tarihten itibaren yürürlüğe girer.</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-sm space-y-3">
                      <p><strong>Veri Sorumlusu:</strong> Mavibilet, kişisel verilerinizin işlenme amacını ve yöntemini belirleyen, veri işleme sisteminin kurulmasından ve yönetilmesinden sorumlu olan gerçek veya tüzel kişidir.</p>
                      <p><strong>Kişisel Veri:</strong> Kimliği belirli veya belirlenebilir gerçek kişiye ilişkin her türlü bilgi kişisel veri olarak tanımlanmaktadır.</p>
                      <p><strong>İşleme Amaçları:</strong> Kişisel verileriniz; hizmet sunumu, iletişim kurulması, yasal yükümlülüklerin yerine getirilmesi amaçlarıyla işlenmektedir.</p>
                      <p><strong>Saklama Süresi:</strong> Kişisel verileriniz, işleme amacının ortadan kalkmasına kadar saklanacaktır.</p>
                      <p><strong>Haklarınız:</strong> KVKK kapsamında bilgi talep etme, düzeltme, silme, işleme sınırlandırılmasını talep etme haklarına sahipsiniz.</p>
                      <p><strong>İletişim:</strong> KVKK ile ilgili başvurularınızı info@mavibilet.com adresine iletebilirsiniz.</p>
                    </div>
                  </div>
                </div>

                {/* Alt Butonlar */}
                <div className="p-6 border-t bg-gray-50 flex flex-col sm:flex-row gap-3 sticky bottom-0">
                  <button
                    onClick={() => setShowContractModal(false)}
