...
const TourDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Desktop Bottom Booking Bar - Two Buttons Side by Side */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 hidden lg:flex z-50 shadow-lg">
        <div className="max-w-7xl mx-auto w-full flex items-center space-x-4">
          {/* Left Button - Sepete Ekle */}
          <button
            onClick={addToCart}
            disabled={!selectedDate}
            className="flex-1 flex items-center justify-center space-x-2 bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 py-4 rounded-lg font-medium transition-colors duration-200 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
          >
            <ShoppingCart className="w-5 h-5" />
            <span>Sepete Ekle</span>
          </button>

          {/* Right Button - Rezervasyon Yap */}
          <button
            onClick={handleBooking}
            disabled={!selectedDate}
            className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white font-medium py-4 rounded-lg transition-colors duration-200 disabled:cursor-not-allowed"
          >
            Rezervasyon Yap
          </button>
        </div>
      ...
      {/* Bottom padding for desktop booking bar */}
