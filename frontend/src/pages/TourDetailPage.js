            ...
            <div className="bg-white rounded-xl p-6 shadow-lg sticky top-8">
              ...
              {tour && (!tour.reservation_type || tour.reservation_type === 'cabin_based') && (
                <div className="mb-6">
                  ...
                  <div className="mb-4">
                    <div className="text-sm font-medium text-gray-700 mb-2">Tek Kişilik Kabin Adedi</div>
              ...
              {/* Desktop Booking Summary - Restored */}
              {selectedDate && (
            ...
            <div className="p-4 space-y-6">
              ...
              {tour && (!tour.reservation_type || tour.reservation_type === 'cabin_based') && (
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-gray-700">Tek Kişilik Kabin Adedi</span>
