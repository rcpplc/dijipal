                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                        ...
                        <div className="flex-1 text-center">
                          <div className="text-center">
                            <span className="text-lg font-bold text-gray-900">{singleCabinCount}</span>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                        ...
                        <div className="flex-1 text-center">
                          <div className="text-center">
                            <span className="text-lg font-bold text-gray-900">{participants || 1}</span>
                            <span className="text-sm text-gray-700 ml-1">Yetişkin</span>
                          </div>
                        </div>
                        <button
                          onClick={() => {
