    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute left-4 z-10 bg-black bg-opacity-50 hover:bg-opacity-70 text-white p-3 rounded-full transition-all duration-200 hidden md:flex items-center justify-center"
        >
